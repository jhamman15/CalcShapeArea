...
int main()
{
    ...
    while (bRun) {
        ...
        case 1://calculate hypotenuse of a triangle a2 + b2 = c2
            ...
            ftriangleC = Hypotenuse.CalculateHypotenuse(ftriangleA, ftriangleB);
        ...
        case 2://calculate area of a trapezoid A = ½(b1+b2)h
            ...
            fTrapezoidA = Area.CalculateTrapezoidArea(fTrapezoidB1, fTrapezoidB2, fTrapezoidH);
        ...
        case 3://calculate volume of a rectangle volume = length x width x height
            ...
            fRectangleV = Volume.CalculateRectangleVolume(fRectangleL, fRectangleW, fRectangleH);
